    ...
    const addUser = (user) => {
        ...
        const row = `
            <tr class="user-item">
                ...
                <td><input value="${user?.rav_first_name}" class="border-0 bg-transparent p-2" type="text" name="firstname" placeholder="Enter Firstname" required></td>
                <td><input value="${user?.rav_last_name}" class="border-0 bg-transparent p-2" type="text" name="lastname" placeholder="Enter Lastname" required></td>
                <td><input value="${user?.rav_email}" class="border-0 bg-transparent p-2" type="email" name="email" placeholder="Enter Email" required></td>
                <td><input value="${user?.rav_gender}" class="border-0 bg-transparent p-2" type="text" name="gender" placeholder="Enter Gender" required></td>
                <td><input value="${user?.rav_address}" class="border-0 bg-transparent p-2" type="text" name="address" placeholder="Enter Address" required></td>
